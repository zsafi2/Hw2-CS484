...
function App() {
    ...
    return (
        <div>
            ...
            {showForm === 'add' && <ProductForm  mode={showForm} onProductAdded={handleafterSubmission} onProductDeleted={undefined} /> }
            {/* TODO Add the necessary props to the underlying component.
            ...
            "none" and navigate to the first page of the product list */}
            {showForm === 'delete' && <ProductForm mode={showForm} onProductAdded={undefined} onProductDeleted={handleafterSubmission}/> }
            {showForm === 'none' && (
                <>
                    {' '}
                    ...
                    <ProductList  products={products} currentPage={currentPage} totalPages={totalPages} setCurrentPage={setCurrentPage}/>
                </>
            )}
        </div>
    )
